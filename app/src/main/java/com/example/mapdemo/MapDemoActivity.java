...
import com.example.mapdemo.utils.PushTest;
import com.example.mapdemo.utils.PushUtilTracker;
import com.example.mapdemo.utils.PushUtils;
...
public class MapDemoActivity extends AppCompatActivity implements
		...
		LocationListener, GoogleMap.OnMapLongClickListener, GoogleMap.OnMarkerDragListener,MarkerUpdatesReceiver.PushInterface {
    ...
    */
    ...
    public void onMarkerDragEnd(Marker marker) {
		...
		PushUtils.sendPushNotification(marker,CHANNEL_NAME);
    }
	...
	public void onMarkerUpdate(PushRequest pushRequest) {
		...
		PushUtilTracker tracker = new PushUtilTracker();
		tracker.handleMarkerUpdates(this,pushRequest,map);
